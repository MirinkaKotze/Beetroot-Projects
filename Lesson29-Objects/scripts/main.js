...
const car = {
    ...
    averageSpeed: 100,
    carInfo: function() {
        console.log(`This car is manufactured by: ${this.manufacturer}, model: ${this.model}, year of Release &{this.yearRelease} and it's average speed is: ${this.averageSpeed}`)
    },
    timeFrame: function(distanceKM) {
        ...
        hours = hoursWithRest;    
        console.log(`The time to travel ${distanceKM}km is ${hours} hours, ${minutes} minutes and ${seconds} seconds.`);
    }
}
// car.carInfo()
// car.timeFrame(1023)
...
function addingFractions(x, y) {
    ...
    console.log(`The new fraction have a numerator of: ${numeratorResult} and a denominator of: ${denominatorResult}`);    
}
// addingFractions(fraction1, fraction2)
...
function simplifying(x) {
    ...
    console.log(`The symplified fraction have a numerator of: ${newNumerator} and a denominator of: ${newDenominator}`); 
}
// simplifying(fraction1)
...
const time = {
    ...
    displayTime: function() {
        if (this.seconds < 10) {
            console.log(`The time is (hh:mm:ss): ${this.hours}:${this.minutes}:0${this.seconds}`);
        }
        else {
            console.log(`The time is (hh:mm:ss): ${this.hours}:${this.minutes}:${this.seconds}`);
        }            
    },
    changeSeconds: function(secondsAdding) {
        ...
        if (this.seconds < 10) {
            console.log(`The time after adding ${secondsAdding} seconds is (hh:mm:ss): ${this.hours}:${newMinutes}:0${newSeconds}`);
        }
        else {
            console.log(`The time after adding ${secondsAdding} seconds is (hh:mm:ss): ${this.hours}:${newMinutes}:${newSeconds}`);
        }      
    },
    changeMinutes: function(minutesAdding) {
        ...
        if (this.seconds < 10) {
            console.log(`The time after adding ${minutesAdding} minutes is (hh:mm:ss): ${newHours}:${newMinutes}:0${this.seconds}`);
        }
        else {
            console.log(`The time after adding ${minutesAdding} minutes is (hh:mm:ss): ${newHours}:${newMinutes}:${this.seconds}`);
        }      
    },
    changeHours: function(hoursAdding) {
        const newHours = this.hours + hoursAdding;
        if (this.seconds < 10) {
            console.log(`The time after adding ${hoursAdding} hours is (hh:mm:ss): &{newHours}:&{this.minutes}:0${this.seconds}`);
        }
        else {
            console.log(`The time after adding ${hoursAdding} hours is (hh:mm:ss): &{newHours}:&{this.minutes}:${this.seconds}`);
        }      
    }
}
// time.displayTime()
